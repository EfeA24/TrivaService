        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierContactPerson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceVisualName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ServiceDocumentUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceVisuals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceVisuals_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceVisuals_ServiceId",
                table: "ServiceVisuals",
                column: "ServiceId");
